...
└── src/
    ...
    └── components/
        ...
        │
        ├── Hero/
        │   └── Hero.jsx              # Seção principal: parallax, edifícios, sticky title
        │
        ├── About/
        │   └── About.jsx             # Texto da empresa com sticky heading
        │
        ├── Investments/
        │   └── Investments.jsx       # Strategic Portfolio: grid de 3 cards interativos
        │
        ├── Shareholders/
        ...
        │
        ├── Footer/
        │   └── Footer.jsx            # Rodapé: preto total, links, copyright
        │
