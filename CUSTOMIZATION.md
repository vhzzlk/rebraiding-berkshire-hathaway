...
// Subtítulo
<Subtitle>
  Berkshire Hathaway — fundamental principles of...
</Subtitle>
```
...
```javascript
<Paragraph>
  We are a holding company owning a diverse group of businesses. Our approach isn't driven by short-term market fluctuations...
</Paragraph>
```
